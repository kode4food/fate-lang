...
var compiler = fate.Compiler;
var generateNodeModule = compiler.generateNodeModule;
var formatSyntaxError = compiler.formatSyntaxError;
var formatWarning = compiler.formatWarning;
...
function commandLine(args, console, exitCallback) {
  ...
  function compileInputScript(inputPath) {
    ...
    return fate.Compiler.compileModule(intContent);
  }
  ...
  function displayVersion() {
    console.info("Fate v" + fate.VERSION);
    console.info("");
  }
