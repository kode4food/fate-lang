...
None    = "None"    !IdentCont  { return node('none'); }
Some    = "Some"    !IdentCont  { return node('some'); }
...
ReservedWord "reserved word"
  = ( For / Def / When / From / Import / Export / Let / And / Or /
      Like / Mod / Not / None / Some / If / Unless / True / False / 
      As / In / Return / Self / Else / End / Where / Select )
